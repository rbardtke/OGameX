//! Original battle engine implementation
//!
//! This is the original implementation that expands all units into individual instances.
...
pub struct BattleInput {
    pub attacker_units: HashMap<i16, BattleUnitInfo>,
    pub defender_units: HashMap<i16, BattleUnitInfo>,
}
...
#[derive(Serialize, Deserialize, Clone)]
pub struct BattleUnitInfo {
    pub unit_id: i16,
    pub amount: u32,
    pub attack_power: f32,
    pub shield_points: f32,
    pub hull_plating: f32,
    pub rapidfire: HashMap<i16, u16>,
}

/// Battle unit count to keep track of the amount of units of a certain type.
#[derive(Serialize, Deserialize, Clone)]
pub struct BattleUnitCount {
    pub unit_id: i16,
    pub amount: u32,
}
...
pub struct MemoryMetrics {
    pub peak_memory: u64, // in kilobytes
}
